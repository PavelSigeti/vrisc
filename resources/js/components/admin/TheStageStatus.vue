<template>
    ...
    <!-- <button class="btn btn-default btn-settings mb30" @click="finishGroupStage" v-if="status === 'default' || status === 'group'">Завершить групповой этап</button> -->
    <button class="btn btn-default btn-settings mb30" @click="finishStage" v-if="status === 'default' || status === 'group'">Завершить регату</button>
</template>
